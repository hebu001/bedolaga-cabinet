      ...
      <div className="flex items-start gap-4">
        <div className="min-w-0 flex-1">
          <div className="mb-1.5 flex flex-wrap items-center gap-2">
            ...
            <span className="text-xs text-apple-faint">#{article.id}</span>
          </div>

          <p className="truncate text-sm font-medium text-apple-ink">{article.title}</p>
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          <button
            ...
            className={`min-h-[44px] min-w-[44px] rounded-lg p-2.5 transition-colors ${
              article.is_featured
                ? 'text-apple-amber hover:bg-apple-amber/10'
                : 'text-apple-faint hover:bg-apple-elevated hover:text-apple-mute'
            }`}
      ...
      {totalPages > 1 && (
        <div className="apple-card-grad flex items-center justify-center gap-2 rounded-2xl bg-apple-card p-4">
          <button
            ...
            disabled={page === 0}
            className="min-h-[44px] rounded-lg bg-apple-elevated px-4 py-2.5 text-apple-mute hover:bg-apple-elevated/70 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {t('common.back')}
          </button>
